...
[self copyDefaultStoreIfNecessary];
    ...
    } //End of copying the preload to the app DB
    
    //Setup Magical Record with the CoreData Stack
    [MagicalRecord setupCoreDataStackWithStoreNamed:@"Trips_54Miles.sqlite"];
    
    //Test to Find all of the MetaMiles entries in the Trips Database & return array
    NSArray *miles = [MetaMiles MR_findAll];

    NSLog(@"App Delegate fired without issue!");
